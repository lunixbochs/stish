...
class Edit:
    ...
    def __exit__(self, type, value, traceback):
        ...
        if sublime.version().startswith('2'):
            ...
            sublime.stish_edit_storage[key] = self.run
            view.run_command('apply_stish_edit', {'key': key})


class apply_stish_edit(sublime_plugin.TextCommand):
    def run(self, edit, key):
        sublime.stish_edit_storage.pop(key)(self.view, edit)
